    ...
    return (
      ...
      <div class="h-screen w-full flex justify-center flex flex-col w-full md:w-1/3 items-center max-w-4xl transition duration-1000 ease-out">
        <div className="flex flex-col justify-center items-center rounded-md shadow-2xl h-2/3 w-full bg-black">
          ...
          <p className='text-white mb-8 text-sm font-medium cursor-pointer' onClick={() => navigate("/optionsignup/signupuser")}>Create a New Account?</p>
        </div>
      </div>
    )
  }
      ...
      <div class="h-screen w-full flex justify-center flex flex-col w-full md:w-1/3 items-center max-w-4xl transition duration-1000 ease-out">
        <div className="flex flex-col justify-center items-center rounded-md shadow-2xl h-2/3 w-full bg-black">
          ...
          <div className='flex flex-col items-center justify-center mt-2'>
            <input type="password" className='rounded-md px-2 py-1 w-4/5 md:w-full border-[1px] border-blue-400 m-1 focus:shadow-md focus:border-pink-400 focus:outline-none focus:ring-0' placeholder='Name'></input>
          ...
          <p className='text-white mb-4 text-sm font-medium cursor-pointer' onClick={() => navigate("/optionlogin/loginuser")}>Sign In to your Account?</p>
        </div>
      </div>
    )
  }
